...
> 现在我们已经讨论了迭代器是什么，让我们回到流（streams）。正如我们所看到的，流是迭代器的异步版本。好的，我们看看它的定义:
...
> 为了让你理解在原始的 trait 中发生了什么，让我们快速看一下以下类型定义:[**Future**](https://doc.rust-lang.org/std/future/trait.Future.html) 是一个承诺在未来产生值的类型。[**Poll**](https://doc.rust-lang.org/std/task/enum.Poll.html) 是在异步世界和同步世界之间建立一座桥梁的类型。它只能有2种变体:
